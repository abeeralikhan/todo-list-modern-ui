    ...
    return this.state.todos.map((todo) => {
      ...
      return (
        <Todo
          ...
          togglePropertyFn={this.toggleProperty}
          updateTodoFn={this.updateTodo}
          toggleCompleteFn={this.toggleComplete}
          isDone={todo.isDone}
        />
      );
    });
    ...
    return (
      <div>
        <div className="TodoList">
          <h1>
            Todo List <span>Made for Twitter's #100DaysOfCode</span>
          </h1>
